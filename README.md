...
```bash
git clone --recurse-submodules https://github.com/flags-2-env-test/php-app
cd php-app
docker build -t f2e-fixture-php .
docker run --rm f2e-fixture-php
```
...
docker run --rm -v /tmp/mutant.toml:/app/.cli-flags.toml:ro f2e-fixture-php
